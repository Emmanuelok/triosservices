...
export function Planner() {
  ...
  return <><Intro eyebrow="ONE PROPERTY. A THOUGHTFUL YEAR OF CARE." title="Build a plan that fits your life.">Choose what matters, shape your service mix and arrive at a quote request with the right details already prepared.</Intro><div className="container page-body care-planner-page">
